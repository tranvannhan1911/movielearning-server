"""
Django settings for movie_test project.
...
SECRET_KEY = 'django-insecure-^o=r_$(6&#_b6nop57-hn+qzjc!vufw)m=wppy$o)6sp7*ix8-'
...
ROOT_URLCONF = 'movie_learning.urls'
...
WSGI_APPLICATION = 'movie_learning.wsgi.application'
