...
from core_movie.api.movie import AllMovieView,MovieIdView,SubsView, MovieGroupView
from rest_framework.routers import DefaultRouter

router = DefaultRouter() 
router.register('api', MovieGroupView)

urlpatterns = [
    path('',AllMovieView.as_view(),name='all_movie_api'),
    path('MovieGroup/', include(router.urls)),
